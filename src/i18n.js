export const translations = {
  fr: {
    ...
    toolbar_lock: 'Verrouiller',
    toolbar_unlock: 'Déverrouiller',
    ...
    carpet_thick_price_with_footprint: '+{total} €',
    footprint_thick_detail_with_carpet: 'Lié à la moquette principale : les deux deviennent épaisses. Empreinte +30 € + moquette ({carpet} €).',
    footprint_thick_price_with_carpet: '+{total} €',
    ...
    counter_logo_add: 'Importer une image JPG, PNG, SVG ou WebP',
    ...
    validation_confirmed_admin_note: 'Scène confirmée côté admin. Vous pouvez encore la modifier.',
    validation_confirmed_client_note: 'Votre scène est confirmée. Vous pouvez encore la modifier tant que l’équipe Stand-ING ne l’a pas verrouillée.',
    ...
    client_correction_cta: 'Vos informations sont incorrectes ?',
    client_correction_title: 'Corriger mes informations',
    client_correction_intro: 'Indiquez les informations à corriger. Notre équipe les vérifiera et mettra votre dossier à jour.',
    client_correction_placeholder: 'Ex : le bon email est contact@societe.fr, la fonction est Responsable événementiel...',
    client_correction_send: 'Envoyer la correction',
    client_correction_sent: 'Demande de correction envoyée à Stand-ING.',
    client_correction_empty: 'Ajoute le détail des informations à corriger.',
    ...
    question_file_types: 'PNG, JPG, SVG, PDF — Max 10 Mo',
    ...
    poster_format_ratio: 'Ratio à respecter : {ratio} · fichier léger JPG, PNG, SVG ou WebP',
    ...
    img_format_spec: 'Format : {w} × {h} mm · PNG, JPG, SVG ou PDF',
  ...
  en: {
    ...
    led_count: 'Your package includes {count} LED spots. If you want to remove them from your stand, click below.',
    led_keep: 'Keep them',
    ...
    carpet_thick_detail_with_footprint: '8mm thickness, velvet look. Also applies to the footprint: +€30/m² carpet (€{carpet}) + footprint (€{footprint}).',
    carpet_thick_price_with_footprint: '+€{total}',
    footprint_thick_detail_with_carpet: 'Linked to the main carpet: both become thick. Footprint +€30 + carpet (€{carpet}).',
    footprint_thick_price_with_carpet: '+€{total}',
    ...
    reserve_restore: 'Restore storage',
    ...
    partition_head_company_field: 'Company name shown on partition heads',
    partition_head_company_placeholder: 'Company name',
    ...
    counter_included_badge: 'Included',
    counter_logo_spec: 'Recommended format:',
    counter_logo_add: 'Import a JPG, PNG, SVG or WebP image',
    ...
    validation_confirmed_admin_note: 'Scene confirmed on admin side. You can still modify it.',
    validation_confirmed_client_note: 'Your scene is confirmed. You can still modify it until the Stand-ING team locks it.',
    ...
    client_correction_cta: 'Are your details incorrect?',
    client_correction_title: 'Correct my details',
    client_correction_intro: 'Tell us which details need correcting. Our team will check them and update your file.',
    client_correction_placeholder: 'E.g. the right email is contact@company.com, the job title is Event manager...',
    client_correction_send: 'Send correction',
    client_correction_sent: 'Correction request sent to Stand-ING.',
    client_correction_empty: 'Add the details that need correcting.',
    country_france: 'France',
    ...
    question_file_types: 'PNG, JPG, SVG, PDF — Max 10 MB',
    ...
    poster_format_ratio: 'Ratio required: {ratio} · lightweight JPG, PNG, SVG or WebP',
    ...
    img_format_spec: 'Recommended format: {w} × {h} mm · PNG, JPG, SVG or PDF',
