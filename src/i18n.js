export const translations = {
  fr: {
    ...
    wall_cover_preview_upload: 'Aperçu',
    ...
    carpet_thick_detail_with_footprint: 'Épaisseur 8mm, aspect velours — applique aussi l’empreinte moquette',
    carpet_thick_price_with_footprint: '+30 €/m² moquette ({carpet} €) + empreinte ({footprint} €) = +{total} €',
    footprint_thick_detail_with_carpet: 'L’option est liée à la moquette principale : les deux deviennent épaisses.',
    footprint_thick_price_with_carpet: '+30 € empreinte + moquette ({carpet} €) = +{total} €',
  ...
  en: {
    ...
    wall_cover_preview_upload: 'Preview',
    ...
    carpet_thick_detail_with_footprint: '8mm thickness, velvet look — also applies to the carpet footprint',
    carpet_thick_price_with_footprint: '+€30/m² carpet (€{carpet}) + footprint (€{footprint}) = +€{total}',
    footprint_thick_detail_with_carpet: 'This option is linked to the main carpet: both become thick.',
    footprint_thick_price_with_carpet: '+€30 footprint + carpet (€{carpet}) = +€{total}',
